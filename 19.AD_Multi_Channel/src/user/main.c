...
int main()
{
    ...
    while (1) {
        ...
        AD3      = AD_GetValue(ADC_Channel_3);
         OLED_ShowNum(1, 10, AD0, 5);
        OLED_ShowNum(2, 10, AD1, 5);
        OLED_ShowNum(3, 10, AD2, 5);
        OLED_ShowNum(4, 10, AD3, 5);
        Voltage0 = (float)AD0 / 4095 * 3.3;
        Voltage1 = (float)AD1 / 4095 * 3.3;
        Voltage2 = (float)AD2 / 4095 * 3.3;
        Voltage3 = (float)AD3 / 4095 * 3.3;
